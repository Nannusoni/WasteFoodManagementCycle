...
<head>
  ...
  <meta name="keywords" content="Nannu technology,Nannu,IT SOLUTION,DEEPAK SONI,TYIT,BSCIT,BSCCS,ITHUB,IT ENGINEER,LAPTOP,COMPUTER SOLUTION,IT WORK,JOB FOR FRESHER,waste food management,WFMC,wfmc,waste food mgmt,wfmc cycle, food recycle,food chain supply, wfmc near me,donate food,food org near me, donate food to other,FOOD, food, rich, poor,wfmcmgmt">
  <!-- Bootstrap CSS -->
...
<!--   google ad script end -->
  ...
  <title>Waste Food Management Cycle </title>
</head>
<body>
  <!-- Start Navigation -->
  <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    ...
    <div class="collapse navbar-collapse" id="myMenu">
      <ul class="navbar-nav pl-2 custom-nav">
        ...
        <li class="nav-item"><a href="#registration" class="nav-link">SIGNUP</a></li>
        <li class="nav-item"><a href="Requester/RequesterLogin.php" class="nav-link">LOGIN</a></li>
		<li class="nav-item"><a href="Ngo/ngo.php" class="nav-link">NGO</a></li>	
		<li class="nav-item"><a href="Admin/login.php" class="nav-link">ADMIN</a></li>
        <li class="nav-item"><a href="#Contact" class="nav-link">FEEDBACK</a></li>
      </ul>
...
<form class="form-inline my-2 my-lg-0">
  ...
  <header class="jumbotron back-image" style="background-image: url(images/Banner11.png);">
    <div class="myclass mainHeading">
      ...
      <h3 class="text-success text-uppercase font-strong-bold">Reduce Food Waste & serve to needy is our Aim</h3>
      <div>
      <P class="font-italic">INTRODUCTION :<br>
         Hello Dear Visitor, Our Name is Nandeshwar Soni & Abhishek Yadav.<br>
         We have made together this project "Waste Food Management cycle"<br> 
         We are living in Mumbai.Pursuing BSCIT Final year.</p><br>
	  <p class="font-italic">AUTHOR DETAILS :<br>
       We are creating Blog post related to th Computer Hardware, Networking.<BR>
       Software, Software Download, Hardware and Networking Notes.<br>
       Technology, Mobile App, Online Earning, Social Network Tips & Tricks<br>
       YouTube Tips, Online Shopping, Affiliate Marketing, create new account<br> 
       make money YouTube, website Creation, blogging tips and tricks, online banking. <br> 
       YouTube videos creation, etc We will share on our facebook page and also share on Telegram.
      </P>
      <a href="about.php" class="btn btn-warning">CLCIK HERE TO KNOW MORE</a><br><br>
    </div>
      <a href="Requester/RequesterLogin.php" class="btn btn-success mr-8">LOGIN</a>
      <a href="UserRegistration.php" class="btn btn-danger mr-8">SIGN UP</a>
    </div>
  </header> <!-- End Header Jumbotron -->
  <div class="container">
<!--   google amp script start -->
...
<!--   google amp script ent -->
    <!--Introduction Section-->
    <div class="jumbotron">
      <h3 class="text-center">WELCOME TO WFMC </h3>
      <p class ="text-Sentance case text-info font-strong-bold">Background/ Problem Statement:<br><br>
  ...
  <div class="container text-center border-bottom" id="Services">
    <h2>WE WOULD REQUEST YOU TO USE OTHR SERVICES AS WELL</h2>
    <div class="row mt-4">
  ...
  <div class="jumbotron bg-danger" id="Customer">
    ...
    <div class="container">
      ...
      <h2 class="text-center text-white">DONOR LIST | HAPPY DONOR ❤️</h2>
      <div class="row mt-5">
        <div class="col-lg-3 col-sm-6">
          <!-- Start Donor 1st Column-->
        ...
        </div> <!-- End DONOR 1st Column-->

        <div class="col-lg-3 col-sm-6">
          <!-- Start Donor 2nd Column-->
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
        ...
        </div> <!-- End donor 2nd Column-->

        <div class="col-lg-3 col-sm-6">
          <!-- Start donor 3rd Column-->
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
        ...
        </div> <!-- End donor 3rd Column-->

        <div class="col-lg-3 col-sm-6">
          <!-- Start donor 4th Column-->
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
        ...
        </div> <!-- End donor 4th Column-->
      </div> <!-- End donor Row-->
    </div> <!-- End donor Container -->
  </div> <!-- End donor Jumbotron -->
  ...
  <div class="container" id="Contact">
    ...
    <h2 class="text-center mb-4">CONTACT US IF YOU HAVE ANY QUERY</h2> <!-- Contact Us Heading -->
    <div class="row">
...
if(isset($_REQUEST['submit'])) {
 ...
 $mailTo = "wastefoodmgmtcycle@gmail.com";
 $headers = "From: ". $email;
 ...
 <form action="" method="post">
  ...
  <?php if(isset($msg)) {echo $msg; } ?>
      ...
      <div class="col-md-4 text-center">
        ...
        Phone: +91  8108155468<br>
        <a href="#" target="_blank">www.wfmc.com</a> <br>
      </div> <!-- End Contact Us 2nd Column-->
    </div> <!-- End Contact Us Row-->
  </div> <!-- End Contact Us Container-->
  <!-- End Contact Us -->
 <h2 class="text-center">FOOD CRISES STORY OF SOUTH AFRICA </h2>
        <iframe align="center" width="100%" height="500" src="https://www.youtube.com/embed/P7A_qY9VX10">
</iframe>
  <!-- Start Footer-->
  <footer class="container-fluid bg-dark text-white mt-5" style="border-top: 2px solid #DC3545;">
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6">
		 ...
		 <footer>&copy; Copyright 2023 WFMC</footer> </div> 
    ...
    <a href="https://www.instagram.com/official_abhishek__24/"</a> Abhishek Yadav</br>
         ...
         <small class="ml-2"><a href="privacy&policy.php">Privacy & Policy</a></small>
		 <small class="ml-2"><a href="terms&condition.php">Terms & Conditoons</a></small>
		 <small class="ml-2"><a href="#">News & Media</a></small>
		 <small class="ml-2"><a href="#">Careers</a></small>
