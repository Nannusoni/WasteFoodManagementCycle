<?php    
define('TITLE', 'Update Riders');
define('PAGE', 'Update Rider');
...
session_start();
 ...
 if(isset($_REQUEST['empupdate'])){
  ...
  $sql = "UPDATE riders_tb SET empName = '$eName', empCity = '$eCity', empMobile = '$eMobile', empEmail = '$eEmail' WHERE empid = '$eId'";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
 ...
 if(isset($_REQUEST['view'])){
  $sql = "SELECT * FROM riders_tb WHERE empid = {$_REQUEST['id']}";
 ...
 ?>
  <form action="" method="POST">
    ...
    <div class="text-center">
      ...
      <a href="rider.php" class="btn btn-secondary">Close</a>
    </div>
